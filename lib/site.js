...
// Authoritative external profiles for the BrainScribe *entity* — fed verbatim
// into `sameAs` on the Organization schema. This is the strongest signal a search
// engine or AI assistant has for "the brainscribe.io site and this directory
// listing / social profile are the same organization".
//
// ⚠️ Every URL here must be a real, live page that BrainScribe actually controls or
// is actually listed on — a guessed or aspirational URL is worse than none (it
// resolves the entity to the wrong thing, or 404s). `organizationSchema()` omits
// `sameAs` entirely while this array is empty.
//
// Add official social/profile URLs (LinkedIn / X / YouTube) as they exist — each one
// is another independent corroboration that this is the same organization.
export const SAME_AS = [
  // ISTE EdTech Index listing (supplied by Danny Wagner, ISTE, 2026-07-26).
  'https://edtechindex.org/product/ultid/P454-E623-146F-48B1-97/',
]
