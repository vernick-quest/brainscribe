...
//
// ⚠️ INTENTIONALLY EMPTY. Every URL here must be a real, live page that BrainScribe
// actually controls or is actually listed on — a guessed or aspirational URL is
// worse than none (it resolves the entity to the wrong thing, or 404s). Robert
// must supply them; the ISTE listing is the prime candidate, plus any official
// LinkedIn / X / YouTube. `organizationSchema()` omits `sameAs` entirely while
// this array is empty, so adding a URL here is the only step needed.
