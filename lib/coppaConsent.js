...
export async function grantConsentForPending(service, { pending, parentUserId, ip = null, userAgent = null, method = 'email_plus' }) {
  ...
  // Both the approved student and the consenting parent also take a Beta Circle slot
  // up to the fluid cap of 100 (Robert: anyone who joins during beta counts). Best-
  // effort — the cap check is inside maybeGrantBetaCircle; never blocks consent.
  await maybeGrantBetaCircle(service, pending.student_id)
  await maybeGrantBetaCircle(service, parentUserId)
