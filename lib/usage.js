...
// comparison, not a true marginal cost. Override via env to match your plan
// (monthly plan cost ÷ monthly character allotment, or your overage rate).
const ELEVENLABS_USD_PER_CHAR = Number(process.env.ELEVENLABS_USD_PER_CHAR) || 0.00022
