...
export async function updateSession(request) {
  ...
  const publicPaths = ['/login', '/invite', '/api/auth', '/api/cron', '/privacy', '/terms', '/about', '/blog', '/coppa/consent', '/welcome']
  // The marketing landing page at `/` must be reachable logged-out (cold campaign
  // traffic lands here) — matched exactly so it doesn't widen the prefix check.
