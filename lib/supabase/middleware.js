...
export async function updateSession(request) {
  ...
  const publicPaths = ['/login', '/invite', '/api/auth', '/api/cron', '/api/admin/backfill-writing-profiles', '/privacy', '/terms', '/about', '/blog', '/coppa/consent', '/coppa/confirm', '/welcome', '/faq', '/compare', '/writing-help']
