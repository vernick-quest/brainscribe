...
export function growComponents(components, addCount, opts = {}) {
  ...
  // Prose grows by a BODY paragraph. Inheriting the last section's type would append a
  // SECOND conclusion to any finished essay (its last section is the conclusion), handing
  // the student echo/thesis_restate/closing slots where they meant another body paragraph.
  // Custom stays custom. An explicit opts.type still wins.
