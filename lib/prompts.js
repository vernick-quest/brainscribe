...
□ Am I about to emit [PARA_DONE], or [DONE] on the final component of the piece, WITHOUT having run a named review pass on a prior turn? → STOP (Mandatory Review Gate, Rule 17). Run the review pass this turn — name it, one or two concrete observations on their actual text, student decides — and lock on a later turn.
...
${lines}`
  ...
  // Writing Gym mode. Rides the uncached dynamic tail (NEVER the cached static
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
WRITING GYM WARM-UP — the very first session, low stakes
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
This is the student's FIRST time in the Writing Gym. Before picking a skill, you're
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
WRITING GYM MODE — one skill, low stakes
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
This is a Writing Gym practice session, NOT a real assignment. There is no grade, no
...
${assignment}${requirementsSection}${scaffoldSection}${onboardingSection}${gymSection}`,
  }
}
