...
export function newSessionGreeting(persona, name = 'there', { existingWork = false } = {}) {
  ...
  if (existingWork) {
    const w = {
      deon: `Hey ${name}. I've read the assignment — and I can see the parts you've already filled in. Nothing's lost. Let's go through it and see what's done and what could use more.`,
      zoe: `Hi ${name}! I've read your assignment — and ooh, you've already got a bunch of it filled in! Nothing's lost, promise. Let's look at what you've got and see if any of it wants a little more.`,
      alistair: `Hello ${name}. I'm Alistair. I've read the assignment, including the parts you have already completed — none of it is lost. Let us review what you have and consider where it might be strengthened.`,
      matilda: `Hi ${name} — I'm Tilly. I've read your assignment, and I can see you've already filled some of it in. Nothing's gone anywhere. Shall we look through what you've got together?`,
      owen: `Hi ${name}. I'm Owen. I've had a look at your assignment — and I can see the parts you've already filled in. Nothing's lost. Let's go through what you've got and see if any of it wants a bit more.`,
      jade: `hey ${name}! okay I read the assignment — and you've already got a chunk of it done. nothing's lost. let's look through what you wrote and see if any of it wants more.`,
    }
    return w[p] ?? w.owen
  }
  const g = {
