...
export default async function AdminPage() {
  ...
  const [
    ...
    service.from('profiles').select('id, full_name, email, role, created_at, sessions_used, onboarding_complete, age_bracket, coppa_consent_given').order('role').order('created_at'),
