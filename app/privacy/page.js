    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li><strong>Session transcripts</strong> — the full dialogue between the student and the AI coach. Stored so students, and their linked parents and teachers, can review the session. We may also review transcripts — including with automated tools — to monitor the AI coach&rsquo;s quality and to help keep students safe.</li>
    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li><strong>How long we keep it</strong> — if you never receive an invite and never create an account, we delete the address <strong>12 months</strong> after you join the list. We delete it sooner if you ask us to, or if we remove you from the queue. If the address becomes a BrainScribe account, it follows that account instead — including being deleted with the account, and under our 7-day parental-consent rule where that applies. We delete addresses once we no longer need them.</li>
