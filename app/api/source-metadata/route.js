...
export async function POST(request) {
  ...
  // Coach reachability gate (lib/access.js) — citation lookup is part of the coached
  // research flow (and a server-side fetch on the student's behalf), so an unconsented
  // under-13 OR an authed user with no Beta access must not reach it.
